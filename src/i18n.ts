...
export const i18n: Record<Lang, LangPack> = {
  en: {
    ...
    resetBtn: "Reset Default Example",
    accPlaceholder: "Enter new account name (e.g., Shared, Credit Card)",
    ...
    defaultAccs: ["Account A", "Account B", "Account C", "Cash"],
    /* ---- Family view ---- */
    ...
    famSection2: "2. Expense Details",
    famSection3: "3. Account Summary",
    ...
    defaultMembers: ["Dad", "Mom", "Kid"],
    defaultExpAccounts: ["Cash", "Credit Card"],
  ...
  zh: {
    ...
    resetBtn: "恢復預設範例",
    accPlaceholder: "輸入新帳戶名稱（如：公用帳戶、玉山信用卡）",
    addAccBtn: "新增帳戶",
    ...
    resetFamilyBtn: "恢復預設",
    memberLabel: "家庭成員",
    addMemberPh: "新增家庭成員（如：爸爸、媽媽）",
    addMemberBtn: "新增成員",
    expAccLabel: "支出帳號",
    addExpAccPh: "新增支出帳號（如：現金、信用卡）",
    addExpAccBtn: "新增帳號",
    entryTitle: "2. 新增一筆支出",
    ...
    famSection2: "2. 各筆支出明細",
    famSection3: "3. 各帳號統計總表",
    exportCsvBtn: "匯出 CSV",
    thPurpose: "用途",
    thNote: "備註",
    thCalcMethod: "計算方式",
    ...
    purposes: ["餐飲", "交通", "娛樂", "日常用品", "買菜", "醫療", "旅遊", "加油", "停車", "小孩", "其他"],
    defaultMembers: ["爸爸", "媽媽", "小孩"],
    defaultExpAccounts: ["現金", "信用卡"],
